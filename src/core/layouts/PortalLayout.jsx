...
const menus = {
  admin: [
    ...
    { label: 'Giảng viên', to: '/admin/lecturers', icon: 'users' },
    { label: 'Môn học & CTĐT', to: '/admin/subjects', icon: 'book' },
    { label: 'Giảng dạy & TKB', to: '/admin/course-sections', icon: 'calendar' },
    { label: 'Đăng ký học phần', to: '/admin/registrations', icon: 'book' },
    { label: 'Bảng điểm tổng hợp', to: '/admin/gradebooks', icon: 'score' },
    { label: 'Báo cáo & Excel', to: '/admin/reports', icon: 'report' },
    { label: 'Thông báo', to: '/admin/announcements', icon: 'report' },
    { label: 'Tài khoản', to: '/admin/users', icon: 'users' },
  ],
  lecturer: [
    { label: 'Tổng quan', to: '/lecturer', icon: 'dashboard' },
    ...
    { label: 'Thông tin & thông báo', to: '/lecturer/info', icon: 'report' },
  ],
  student: [
    { label: 'Thời khóa biểu', to: '/student/schedule', icon: 'calendar' },
    { label: 'Đăng ký học phần', to: '/student/register', icon: 'book' },
    { label: 'Chuyên cần', to: '/student/attendance', icon: 'attendance' },
    { label: 'Bảng điểm', to: '/student/grades', icon: 'score' },
    { label: 'Hồ sơ cá nhân', to: '/student/profile', icon: 'users' },
